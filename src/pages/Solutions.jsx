  ...
  return (
    <div data-screen-label="Solutions">
      <section style={{position:"relative",background:"#191919",padding:"170px clamp(20px,4vw,56px) clamp(70px,8vw,110px)",overflow:"hidden"}}>
        <div style={{position:"absolute",inset:0,background:"radial-gradient(55% 60% at 80% 15%,rgba(2, 88, 204,.22),transparent 60%),radial-gradient(55% 60% at 10% 95%,rgba(67,147,74,.2),transparent 60%)"}}></div>
        ...
        <div style={{position:"relative",maxWidth:1240,margin:"0 auto"}}>
          <div data-reveal className="shown" style={{display:"inline-flex",alignItems:"center",gap:8,fontFamily:"Caveat, cursive",color:"#0258CC",fontWeight:600,fontSize:24,letterSpacing:"0",marginBottom:22}}><span style={{width:26,height:2,background:"#0258CC"}}></span>Solutions</div>
        ...
        <div style={{maxWidth:1240,margin:"0 auto"}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"repeat(6,1fr)",gap:20,marginTop:60}} data-3col>
            <div data-reveal onClick={() => go("food")} className="lift" style={{gridColumn:"span 4",position:"relative",minHeight:300,borderRadius:32,overflow:"hidden",background:"linear-gradient(135deg,#191919,#242424)",padding:36,display:"flex",flexDirection:"column",justifyContent:"space-between",cursor:"pointer"}}>
              <div style={{position:"absolute",inset:0,background:"radial-gradient(60% 70% at 85% 20%,rgba(2, 88, 204,.3),transparent 60%)"}}></div>
              <div style={{position:"relative",display:"flex",justifyContent:"space-between",alignItems:"flex-start"}}>
                <div style={{width:48,height:48,borderRadius:16,background:"rgba(2, 88, 204,0.2)",display:"flex",alignItems:"center",justifyContent:"center",color:"#0258CC"}}>
              ...
              <div style={{position:"relative"}}>
                ...
                <span style={{display:"inline-flex",alignItems:"center",gap:6,marginTop:16,color:"#0258CC",fontWeight:600,fontSize:14}}>Explore <ArrowRight size={16} /></span>
              </div>
            </div>
            ...
            <div data-reveal data-delay="1" onClick={() => go("ifm")} className="lift" style={{gridColumn:"span 2",position:"relative",minHeight:300,borderRadius:32,overflow:"hidden",background:"linear-gradient(135deg,#242424,#2E2E2E)",padding:30,display:"flex",flexDirection:"column",justifyContent:"space-between",cursor:"pointer"}}>
              ...
              <div style={{position:"relative"}}>
                ...
                <span style={{display:"inline-flex",alignItems:"center",gap:6,marginTop:14,color:"#0258CC",fontWeight:600,fontSize:14}}>Explore <ArrowRight size={16} /></span>
              </div>
            </div>
            ...
            <div data-reveal data-delay="2" onClick={() => go("workforce")} className="lift" style={{gridColumn:"span 2",position:"relative",minHeight:300,borderRadius:32,overflow:"hidden",background:"linear-gradient(135deg,#191919,#242424)",padding:30,display:"flex",flexDirection:"column",justifyContent:"space-between",cursor:"pointer"}}>
              <div style={{position:"absolute",inset:0,background:"radial-gradient(70% 70% at 50% 20%,rgba(2, 88, 204,.28),transparent 60%)"}}></div>
              <div style={{position:"relative",display:"flex",justifyContent:"space-between",alignItems:"flex-start"}}>
                <div style={{width:48,height:48,borderRadius:16,background:"rgba(2, 88, 204,0.2)",display:"flex",alignItems:"center",justifyContent:"center",color:"#0258CC"}}>
                  <Users size={24} />
                </div>
      ...
      <section style={{padding:"clamp(80px,10vw,140px) clamp(20px,4vw,56px)",background:"#F9F7F3"}}>
        <div style={{maxWidth:1240,margin:"0 auto"}}>
          <div style={{textAlign:"center",maxWidth:820,margin:"0 auto 56px"}}>
            <div data-reveal style={{display:"inline-flex",alignItems:"center",gap:8,fontFamily:"Caveat, cursive",color:"#014299",fontWeight:600,fontSize:24,letterSpacing:"0",marginBottom:18,justifyContent:"center"}}><span style={{width:26,height:2,background:"#0258CC"}}></span>The Catalyst Advantage<span style={{width:26,height:2,background:"#43934A"}}></span></div>
      ...
      <section style={{padding:"clamp(20px,4vw,56px)"}}>
        <div data-reveal style={{maxWidth:1300,margin:"0 auto",position:"relative",borderRadius:40,overflow:"hidden",background:"linear-gradient(135deg,#191919,#242424)",padding:"clamp(60px,9vw,120px) clamp(28px,5vw,80px)",textAlign:"center"}}>
          <div style={{position:"absolute",inset:0,background:"radial-gradient(50% 70% at 20% 20%,rgba(2, 88, 204,.25),transparent 60%),radial-gradient(50% 70% at 80% 80%,rgba(67,147,74,.25),transparent 60%)"}}></div>
          <div style={{position:"relative"}}>
            ...
            <div style={{display:"flex",flexWrap:"wrap",gap:16,justifyContent:"center",marginTop:36}}>
              <button className="mag" onClick={() => go("contact")} style={{background:"#0258CC",color:"#fff",fontWeight:600,fontSize:16,padding:"17px 36px",borderRadius:999,display:"inline-flex",alignItems:"center",gap:8}}>Partner With Us <ArrowRight size={18} /></button>
            </div>
          </div>
        </div>
      </section>
