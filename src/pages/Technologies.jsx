    ...
    <div data-screen-label="Technologies">
      ...
      <section style={{ position: "relative", background: "#191919", padding: "230px clamp(20px,4vw,56px) clamp(130px,10vw,180px)", minHeight: "65vh", overflow: "hidden", backgroundImage: `url(${heroBg})`, backgroundSize: "cover", backgroundPosition: "center" }}>
        ...
        <div style={{ position: "relative", maxWidth: 1240, margin: "0 auto" }}>
          <div data-reveal className="shown" style={{ display: "inline-flex", alignItems: "center", gap: 8, fontFamily: "Caveat, cursive", color: "#0258CC", fontWeight: 600, fontSize: 24, letterSpacing: "0", marginBottom: 22 }}><span style={{ width: 26, height: 2, background: "#0258CC" }}></span>Technology Solutions</div>
      ...
      <section style={{ padding: "clamp(80px,10vw,140px) clamp(20px,4vw,56px)", background: "#fff", position: "relative", zIndex: 1, marginTop: -100, borderRadius: "48px 48px 0 0" }}>
        <div style={{ maxWidth: 1240, margin: "0 auto" }}>
          <div style={{ maxWidth: 760, marginBottom: 60 }}>
            <div data-reveal style={{ display: "inline-flex", alignItems: "center", gap: 8, fontFamily: "Caveat, cursive", color: "#014299", fontWeight: 600, fontSize: 24, letterSpacing: "0", marginBottom: 18 }}><span style={{ width: 26, height: 2, background: "#0258CC" }}></span>Our Products</div>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 6, fontSize: 13, color: "#6E6A61" }}>
                      {prod.process.map((step, si) => (
                        <React.Fragment key={si}>
                          ...
                          {si < prod.process.length - 1 && <span style={{ color: "#0258CC" }}>→</span>}
                        </React.Fragment>
                      ))}
                    </div>
                  </div>
