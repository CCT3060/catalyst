...
const sectors = [
  {
    num: "01", color: "#0258CC", labelColor: "#014299", label: "CORPORATE", title: "Corporate & Commercial Spaces",
  ...
  {
    num: "04", color: "#0258CC", labelColor: "#014299", label: "EDUCATION", title: "Education",
    ...
    <div data-screen-label="Sectors">
      ...
      <section style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "center", padding: "120px clamp(20px,4vw,56px) 60px", overflow: "hidden", backgroundImage: "linear-gradient(rgba(25, 25, 25, 0.74), rgba(25, 25, 25, 0.21)), url(https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&q=80&w=2000)", backgroundSize: "cover", backgroundPosition: "center" }}>
        <div style={{ position: "relative", maxWidth: 1240, width: "100%", margin: "0 auto" }}>
          <div data-reveal className="shown" style={{ display: "inline-flex", alignItems: "center", gap: 8, fontFamily: "Caveat, cursive", color: "#0258CC", fontWeight: 600, fontSize: 24, letterSpacing: "0", marginBottom: 22 }}><span style={{ width: 26, height: 2, background: "#0258CC" }}></span>Sectors</div>
      ...
      <section style={{ padding: "clamp(80px,10vw,140px) clamp(20px,4vw,56px)", background: "#191919", position: "relative", overflow: "hidden" }}>
        <div style={{ position: "absolute", inset: 0, background: "radial-gradient(50% 60% at 20% 20%,rgba(2, 88, 204,.16),transparent 60%),radial-gradient(50% 60% at 85% 90%,rgba(67,147,74,.16),transparent 60%)" }}></div>
        <div style={{ position: "relative", maxWidth: 980, margin: "0 auto", textAlign: "center" }}>
          <div data-reveal style={{ display: "inline-flex", alignItems: "center", gap: 8, fontFamily: "Caveat, cursive", color: "#0258CC", fontWeight: 600, fontSize: 24, letterSpacing: "0", marginBottom: 18, justifyContent: "center" }}><span style={{ width: 26, height: 2, background: "#0258CC" }}></span>Our Approach Across Sectors</div>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 16, justifyContent: "center", marginTop: 38 }}>
            <button className="mag" onClick={() => go("contact")} style={{ background: "#0258CC", color: "#fff", fontWeight: 600, fontSize: 16, padding: "17px 36px", borderRadius: 999 }}>Let's Create Impact Together! →</button>
